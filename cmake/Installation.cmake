...
if(APPLE)
  ...
  # Search for createdmg in ../ci_tools/platform/macos and
  # third_party/ci-tools/platform/macos. If it doesn't exist anywhere, download it.
  if(EXISTS "${CMAKE_SOURCE_DIR}/../ci_tools/platform/macos/createdmg")
